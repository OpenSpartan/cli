...
namespace OpenSpartan.CLI.Core
{
    ...
    {
        // Stop-gap solution before I have a better Markdown implementation.
        // Source: https://github.com/jpierson/to-markdown-table/blob/develop/src/ToMarkdownTable/LinqMarkdownTableExtensions.cs
        internal static string ToMarkdownTable<T>(this IEnumerable<T> source)
        {
